...
public class AppointmentPanel extends JFrame {
    ...
    public AppointmentPanel() {
        ...
        b1 = new JButton("Add Appointment");
        b2 = new JButton("Read All");
        b3 = new JButton("Delete Appointment");
        b4 = new JButton("Search Appointment");
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equalsIgnoreCase("Add Appointment")) {
                dispose();
            ...
            } else if (e.getActionCommand().equalsIgnoreCase("Delete Appointment")) {
                dispose();

            } else if (e.getActionCommand().equalsIgnoreCase("Search Appointment")) {
                dispose();
